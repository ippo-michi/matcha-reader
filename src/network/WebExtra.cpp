...
static std::string getSentencesPath() { return getCacheDir() + "/sentences.json"; }
...
static void handleExportSentences(CrossPointWebServer::RequestPtr req, CrossPointWebServer::ResponsePtr res) {
...
static void handleSaveSentence(CrossPointWebServer::RequestPtr req, CrossPointWebServer::ResponsePtr res) {
  auto& mining = sentence_mining::SentenceMining::instance();
...
static void handleListSentences(CrossPointWebServer::RequestPtr req, CrossPointWebServer::ResponsePtr res) {
  auto& mining = sentence_mining::SentenceMining::instance();
...
static void handleDeleteSentence(CrossPointWebServer::RequestPtr req, CrossPointWebServer::ResponsePtr res) {
  auto& mining = sentence_mining::SentenceMining::instance();
...
static void handleExportSentencesMarkdown(CrossPointWebServer::RequestPtr req, CrossPointWebServer::ResponsePtr res) {
  auto& mining = sentence_mining::SentenceMining::instance();
...
static void handleSaveSentenceMarkdown(CrossPointWebServer::RequestPtr req, CrossPointWebServer::ResponsePtr res) {
  auto& mining = sentence_mining::SentenceMining::instance();
